     ...
     <tr>
      <td valign='top'>
       <table class='es-header' cellspacing='0' cellpadding='0' align='center'>
         <tr>
          <td align='center'>
           <table class='es-header-body' width='900' cellspacing='0' cellpadding='0' bgcolor='#ffffff' align='center'>
             <tr>
...
$html_footer = "</table></td>
       ...
       <table class='es-footer' cellspacing='0' cellpadding='0' align='center'>
         <tr>
          <td align='center'>
           <table class='es-footer-body' width='900' cellspacing='0' cellpadding='0' bgcolor='#ffffff' align='center'>
             <tr>
              <td class='es-p20t es-p20r es-p20l' align='left'>
               <table cellpadding='0' cellspacing='0' width='100%'>
                 <tr>
